...
var cpUpload = upload.fields([
    ...
    { name: 'performanceData', maxCount: 1 },
    { name: 'auditData', maxCount: 1 },
    { name: 'ieResourceMetric', maxCount: 1 }])
app.post('/metric', cpUpload, async function (request, response) {
    ...
    var ieResourceMetric = request.body.ieResourceMetric
    var videoPath = request.files.video[0].path

    Report(metric, auditData, videoPath, ieResourceMetric)
})
